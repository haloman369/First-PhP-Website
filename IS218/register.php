...
<form method="POST">
	...
	<input type="first_name" id="first_name" name="first_name" autocomplete="off" />
	</label>
	
	<label for="last_name">Last Name
	<input type="last_name" id="last_name" name="last_name" autocomplete="off" />
	</label>

	<label for="birthday">Birthday
	<input type="birthday" id="birthday" name="birthday" autocomplete="off" />
	</label>
